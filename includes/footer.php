    <footer>
        ...
        <div class="row mt-sm-5">
          <div class="col-sm-4">
            <div class="block-footer my-4 my-sm-5 text-white">
                  <h4 class="mb-3 h6"><b>CONTACT US</b></h4>
                  <p><i class="fa fa-map-marker" aria-hidden="true"></i> 364; Plateros Street, Plaza de Armas; Cusco; Peru</p>
                  <p><i class="fa fa-envelope-o" aria-hidden="true"></i> info@x-tremetourbulencia.com</p>
                  <p><i class="fa fa-phone" aria-hidden="true"></i> (+51)(84) 225872 - (+51) 984610644</p>
            </div>
          </div>
          <div class="col-sm-4">
            <div class="block-footer my-4 my-sm-5 text-white">
          ...
          <div class="col-sm-4">
            <div class="block-footer social my-4 my-sm-5 text-white text-center">
                ...
                <ul class="list-inline">
                    ...
                    <li class="list-inline-item"><i class="fa fa-youtube" aria-hidden="true"></i></li>
      ...
      <div class="footer-bot text-center py-2">
        <small>Copyright © 2019 Xtreme Tourbulencia. All Rights Reserved </small>
      </div>
    </footer>